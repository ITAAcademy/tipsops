...
$('#pagination').on('click', 'a', function(e) { // When click on a 'a' element of the pagination div
   ...
   // $('#articleArea').html('<img src="design/loader-small.gif" alt="" />'); // Display a processing icon
    ...
    $.ajax({ // jQuery Ajax
        type: 'POST',
        url: 'Content/Controllers/con_rout_pagination.php', // URL to the PHP file which will insert new value in the database
        ...
        success: function(data) {
            ...
            else pagination += '<div class="cell"><a href="#" id="1">First</a></div><div class="cell"><a href="#" id="' + (page - 1) + '">Наступна</span></a></div>';
            ...
            else pagination += '<div class="cell"><a href="#" id="' + (parseInt(page) + 1) + '">Next</a></div><div class="cell"><a href="#" id="' + data.numPage + '">Остання</span></a></div>';
